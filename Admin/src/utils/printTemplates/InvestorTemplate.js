export const InvestorTemplate = ({
  ...
  const certificateNo =
    investor.certNo ||
    `INV-CERT-${Math.floor(100000 + Math.random() * 900000)}`;
  ...
  return `
    <div class="investor-receipt professional-style" style="position: relative; border: 8px solid #1e293b; padding: 10px; background: #fff; box-sizing: border-box; overflow: hidden;">
      <!-- Watermark -->
      ...
      <div style="position: relative; z-index: 1;">
        ...
        <div style="display: flex; align-items: center; justify-content: center; gap: 10px;">
          <div style="margin-bottom: 10px;">
            <img src="kes_logo.jpeg" style="width: 70px; height: 70px; object-fit: contain; border-radius: 50%; border: 2px solid #1e293b;" alt="Logo" />
          </div>
          <h1 style="margin: 0; font-size: 2rem; color: #000; letter-spacing: 1px;">${
            branchDetails.name
          }</h1>
      
        </div>    <p style="margin: 2px 0 0 0; font-size: 0.75rem; color: #64748b; font-weight: 600; text-transform: uppercase; letter-spacing: 2px;">${
        ...
        <!-- Parameters Table -->
        <div style="margin-bottom: 20px; padding: 0 15px; box-sizing: border-box;">
          <table style="width: 100%; border-collapse: collapse; table-layout: fixed; box-sizing: border-box;">
            <thead>
              <tr style="background: #f8fafc; border-top: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0;">
                <th style="padding: 10px 15px; text-align: left; font-size: 0.7rem; color: #64748b; text-transform: uppercase; letter-spacing: 1px; width: 65%;">Investment Details</th>
                <th style="padding: 10px 30px 10px 15px; text-align: right; font-size: 0.7rem; color: #64748b; text-transform: uppercase; letter-spacing: 1px; width: 35%;">Value</th>
              </tr>
            </thead>
            <tbody style="font-size: 0.85rem;">
              <tr>
                <td style="padding: 10px 15px; border-bottom: 1px solid #f1f5f9; color: #475569;">Monthly Interest Rate (per ₹1)</td>
                <td style="padding: 10px 30px 10px 15px; border-bottom: 1px solid #f1f5f9; text-align: right; font-weight: 700; color: #000;">${
                  investor.interestRate
                } Paise</td>
              </tr>
              <tr>
                <td style="padding: 10px 15px; border-bottom: 1px solid #f1f5f9; color: #475569;">Methodology</td>
                <td style="padding: 10px 30px 10px 15px; border-bottom: 1px solid #f1f5f9; text-align: right; font-weight: 700; color: #000; text-transform: capitalize;">${
                  investor.interestType
                }</td>
              </tr>
              <tr>
                <td style="padding: 10px 15px; border-bottom: 1px solid #f1f5f9; color: #475569;">Commencement Date</td>
                <td style="padding: 10px 30px 10px 15px; border-bottom: 1px solid #f1f5f9; text-align: right; font-weight: 700; color: #000;">${issuanceDate}</td>
              </tr>
              <tr>
                <td style="padding: 10px 15px; border-bottom: 1px solid #f1f5f9; color: #475569;">Verification (KYC)</td>
                <td style="padding: 10px 30px 10px 15px; border-bottom: 1px solid #f1f5f9; text-align: right; font-weight: 700; color: #000; text-transform: capitalize;">${
                  investor.kycStatus
                }</td>
              </tr>
        ...
        <!-- Projections -->
        <div style="background: #f1f5f9; padding: 15px; border-radius: 4px; margin-bottom: 15px;">
        ...
        <!-- Declaration Notice -->
        <div style="border-left: 3px solid #1e293b; background: #f8fafc; padding: 10px 15px; margin-bottom: 20px;">
          <p style="margin: 0; font-size: 0.65rem; color: #475569; line-height: 1.4;">
            <strong>Declaration:</strong> This certificate is issued by Kumaran E-Services as a formal acknowledgment of your investment. We declare that the principal amount received will be managed with professional diligence according to our standard investment policies. This document remains valid throughout the tenure of your investment.
          </p>
        </div>

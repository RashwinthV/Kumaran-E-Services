...
const BranchReport = () => {
  ...
  const handleGstExport = async () => {
    ...
    const headerRw = worksheet.addRow(columns.map((c) => c.header));
    headerRw.font = { bold: true, color: { argb: "FFFFFFFF" }, size: 12 };
    headerRw.eachCell((cell) => {
      cell.fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "FF4F81BD" },
